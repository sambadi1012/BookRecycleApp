	...
	<div class="container">
		<div class="row p-2">
			...
			<div class="col-md-6">
				<div class="card">
					<div class="card-body">
						<h3 class="text-center text-success">Your Address Details:</h3>
						...
						<input type="hidden" value="${userobj.id}" name="id">
							...
							<div class="text-center">
								<button class="btn btn-warning">
									<i class="fa-solid fa-wand-magic-sparkles"></i> Place Order
								</button>
								<a href="homepage.jsp" class="btn btn-success"><i
									class="fa-solid fa-arrow-rotate-left"></i> Continue Shopping</a>
							</div>
						</form>
					</div>
				</div>
