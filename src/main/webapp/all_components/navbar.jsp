...
<div class="container-fluid"
	style="height: 10px; background-color: #4db6ac"></div>

<div class="container-fluid p-3">
	<div class="row">
		<div class="col-md-3">
			<h3>
				<i class="fa-solid fa-book"></i> BookRecycle
			</h3>
		</div>
		<div class="col-md-6">
		...
		<div class="col-md-3">
			<a href="checkout.jsp" class="btn"><i class="fa-solid fa-cart-plus fa-2x"></i></a>
...
<nav class="navbar navbar-expand-lg navbar-dark bg-custom">
	<a class="navbar-brand" href="homepage.jsp"><i class="fa-solid fa-house-user"></i></a>
	...
	<div class="collapse navbar-collapse" id="navbarSupportedContent">
		<ul class="navbar-nav mr-auto">
			...
			<li class="nav-item active"><a class="nav-link" href="all_recent_books.jsp"><i
					class="fa-solid fa-book"></i> Recent Books</a></li>
					<li class="nav-item active"><a class="nav-link" href="all_new_books.jsp"><i
					class="fa-solid fa-book"></i> New Books</a></li>
					<li class="nav-item active"><a class="nav-link" href="all_used_books.jsp"><i
					class="fa-solid fa-book"></i> Used Books</a></li>
